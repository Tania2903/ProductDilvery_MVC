...
namespace ProductDilvery_MVC.Controllers
{
    ...
    public class CompaniesController : Controller
    {
        ...
        public CompaniesController(PD_MVCDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var company = await _context.Comapny
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var company = await _context.Comapny.FindAsync(id);
            if (company == null)
            {
                return NotFound();
            }
        ...
        {
            var company = await _context.Comapny.FindAsync(id);
            _context.Comapny.Remove(company);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.Comapny.Any(e => e.Id == id);
        }
    }
}
